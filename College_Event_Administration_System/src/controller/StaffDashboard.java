...
//		int sId, String sname, String semail, String sdesignation, String scity, String sphoneno)
		try {
			UserStaff u=new UserDao().getStaffInfo(email);
			...
			out.print("<h3 style='color: #333333;'> Welcome(Staff) " + u.getSname() + "</h3><br>");
			out.print("<h5>Employee ID: " + u.getsId() + "</h5>");
			out.print("<h5>Name: " + u.getSname() + "</h5>");
			out.print("<h5>Email: " + u.getSemail() + "</h5>");
			out.print("<h5>Designation: " + u.getSdesignation() + "</h5>");
			out.print("<h5>Phone number: " + u.getSphoneno() + "</h5>");
			out.print("</div>");
			out.print("</div>");
