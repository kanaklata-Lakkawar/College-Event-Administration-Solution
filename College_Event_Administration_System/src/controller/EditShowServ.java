...
public class EditShowServ extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			UserStaff us = new UserDao().getOneUser(sId);
...
out.print("<head>");
			...
			out.print("<h4 style='text-align: center;'>Edit Staff Info</h4>");
			out.print(" <form action='editserv' method='get' enctype='multipart/form-data'>");
			
			out.print("<input type='hidden' name='sid' value='" + us.getsId() + "' readonly>");
			
			out.print("  <div class='form-group'>");
			out.print("      <label for='empID'>Employee ID:</label>");
			out.print(" <input type='text' class='form-control' id='sid'  name='sid'value="+us.getsId()+" readonly>");
			out.print(" </div>");
			
			out.print("  <div class='form-group'>");
			out.print("      <label for='name'>Name:</label>");
			out.print(" <input type='text' class='form-control' id='fname'  name='name'value="+us.getSname()+">");
			out.print(" </div>");
			
			out.print("  <div class='form-group'>");
			out.print("      <label for='desig'>Designation:</label>");
			out.print(" <input type='text' class='form-control' id='designation'  name='designation' value="+us.getSdesignation()+" readonly>");
			out.print(" </div>");
			

			out.print("  <div class='form-group'>");
			out.print("      <label for='email'>Email:</label>");
			out.print(" <input type='text' class='form-control' id='email'  name='email' value="+us.getSemail()+">");
			out.print(" </div>");
//			
			out.print("  <div class='form-group'>");
			out.print("      <label for='phone'>Phoneno:</label>");
			out.print(" <input type='text' class='form-control' id='phoneno'  name='phoneno' value="+us.getSphoneno()+">");
			out.print(" </div>");
